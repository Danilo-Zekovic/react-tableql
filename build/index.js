...
var ObservableQuery = (function (_super) {
    ...
    ObservableQuery.prototype.currentResult = function () {
        ...
        var result = {
            data: data,
            loading: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__networkStatus__["b" /* isNetworkRequestInFlight */])(networkStatus),
            networkStatus: networkStatus,
        };
        if (queryStoreValue &&
    ...
    ObservableQuery.prototype.refetch = function (variables) {
        ...
        if (!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_apollo_utilities__["k" /* isEqual */])(this.variables, variables)) {
            this.variables = Object.assign({}, this.variables, variables);
        }
        if (!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_apollo_utilities__["k" /* isEqual */])(this.options.variables, this.variables)) {
    ...
    ObservableQuery.prototype.setVariables = function (variables, tryFetch, fetchResults) {
        ...
        if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_apollo_utilities__["k" /* isEqual */])(newVariables, this.variables) && !tryFetch) {
    ...
    ObservableQuery.prototype.updateQuery = function (mapFn) {
        ...
        var newResult = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_apollo_utilities__["l" /* tryFunctionOrLogError */])(function () {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = valueToObjectRepresentation;
/* unused harmony export storeKeyNameFromField */
/* unused harmony export getStoreKeyName */
/* harmony export (immutable) */ __webpack_exports__["b"] = argumentsObjectFromField;
...
var Observable = (function (_super) {
    ...
    return Observable;
}(__WEBPACK_IMPORTED_MODULE_0_apollo_link__["c" /* Observable */]));
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return LinkError; });
/* harmony export (immutable) */ __webpack_exports__["a"] = isTerminating;
    ...
    if (!transformedOperation.operationName) {
        transformedOperation.operationName =
            typeof transformedOperation.query !== 'string'
                ? __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_apollo_utilities__["j" /* getOperationName */])(transformedOperation.query)
                : '';
    }
...
function getKey(operation) {
    ...
    return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_graphql_language_printer__["print"])(operation.query) + "|" + JSON.stringify(operation.variables) + "|" + operation.operationName;
}
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["b"] = getMutationDefinition;
/* harmony export (immutable) */ __webpack_exports__["i"] = checkDocument;
/* harmony export (immutable) */ __webpack_exports__["d"] = getOperationDefinition;
...
/* harmony export (immutable) */ __webpack_exports__["h"] = getFragmentDefinitions;
/* harmony export (immutable) */ __webpack_exports__["c"] = getQueryDefinition;
...
function getDefaultValues(definition) {
    if (definition &&
        ...
        var defaultValues = definition.variableDefinitions
            ...
            var defaultValueObj = {};
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__storeUtils__["a" /* valueToObjectRepresentation */])(defaultValueObj, variable.name, defaultValue);
...
(function (global, factory) {
    ...
    var invariant$1 = __webpack_require__(0);
    ...
    var invariant$2 = __webpack_require__(0);
    var DocumentType;
    ...
    var invariant$3 = __webpack_require__(0);
    ...
    var invariant$7 = __webpack_require__(0);
    ...
    var hoistNonReactStatics = __webpack_require__(7);
    ...
    var hoistNonReactStatics$1 = __webpack_require__(7);
    ...
    var hoistNonReactStatics$2 = __webpack_require__(7);
    ...
    var invariant$8 = __webpack_require__(0);
    var hoistNonReactStatics$3 = __webpack_require__(7);
...
var supportedDirectives = new __WEBPACK_IMPORTED_MODULE_0_apollo_link__["a" /* ApolloLink */](function (operation, forward) {
    operation.query = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_apollo_utilities__["a" /* removeConnectionDirectiveFromDocument */])(operation.query);
...
var ApolloClient = (function () {
    function ApolloClient(options) {
        ...
        var defaultConnectToDevTools = !__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_apollo_utilities__["b" /* isProduction */])() &&
        ...
        if (!hasSuggestedDevtools && !__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_apollo_utilities__["b" /* isProduction */])()) {
    ...
    ApolloClient.prototype.__requestRaw = function (payload) {
        return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_apollo_link__["b" /* execute */])(this.link, payload);
    };
...
var QueryManager = (function () {
    ...
    QueryManager.prototype.mutate = function (_a) {
        ...
        (mutation = cache.transformDocument(mutation)),
            (variables = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_apollo_utilities__["c" /* assign */])({}, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_apollo_utilities__["d" /* getDefaultValues */])(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_apollo_utilities__["e" /* getMutationDefinition */])(mutation)), variables));
        var mutationString = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_graphql_language_printer__["print"])(mutation);
        ...
        return new Promise(function (resolve, reject) {
                    ...
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            if (errorPolicy === 'ignore' &&
                                storeResult &&
                                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_apollo_utilities__["f" /* graphQLResultHasError */])(storeResult)) {
            ...
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_apollo_link__["b" /* execute */])(_this.link, operation).subscribe({
                next: function (result) {
                    if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_apollo_utilities__["f" /* graphQLResultHasError */])(result) && errorPolicy === 'none') {
    ...
    QueryManager.prototype.fetchQuery = function (queryId, options, fetchType, fetchMoreForQueryId) {
        ...
        if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_apollo_utilities__["g" /* hasDirectives */])(['live'], query))
            shouldFetch = true;
        ...
        if (shouldFetch) {
            var networkResult = this.fetchRequest({
                ...
                if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__errors_ApolloError__["b" /* isApolloError */])(error)) {
                    throw error;
                }
                else {
        ...
        return function (queryStoreValue, newData) {
            ...
            var errorStatusChanged = errorPolicy &&
                (lastError && lastError.graphQLErrors) !==
                    queryStoreValue.graphQLErrors &&
                errorPolicy !== 'none';
            if (!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_10__networkStatus__["b" /* isNetworkRequestInFlight */])(queryStoreValue.networkStatus) ||
                ...
                if (((!errorPolicy || errorPolicy === 'none') &&
                    ...
                    if (observer.error) {
                        ...
                        if (!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_apollo_utilities__["b" /* isProduction */])()) {
                            console.info('An unhandled error was thrown because no error handler is registered ' +
                                'for the query ' +
                                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_graphql_language_printer__["print"])(queryStoreValue.document));
                        }
                    }
                    return;
                }
                try {
                    ...
                    if (isMissing && fetchPolicy !== 'cache-only') {
                        resultFromStore = {
                            ...
                            loading: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_10__networkStatus__["b" /* isNetworkRequestInFlight */])(queryStoreValue.networkStatus),
                            networkStatus: queryStoreValue.networkStatus,
                            stale: true,
                        };
                    }
    ...
    QueryManager.prototype.watchQuery = function (options, shouldSubscribe) {
        ...
        var queryDefinition = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_apollo_utilities__["h" /* getQueryDefinition */])(options.query);
        if (queryDefinition.variableDefinitions &&
            queryDefinition.variableDefinitions.length) {
            var defaultValues = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_apollo_utilities__["d" /* getDefaultValues */])(queryDefinition);
            options.variables = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_apollo_utilities__["c" /* assign */])({}, defaultValues, options.variables);
        }
    ...
    QueryManager.prototype.addObservableQuery = function (queryId, observableQuery) {
        ...
        var queryDef = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_apollo_utilities__["h" /* getQueryDefinition */])(observableQuery.options.query);
    ...
    QueryManager.prototype.removeObservableQuery = function (queryId) {
        ...
        if (!observableQuery)
            return;
        var definition = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_apollo_utilities__["h" /* getQueryDefinition */])(observableQuery.options.query);
    ...
    QueryManager.prototype.startGraphQLSubscription = function (options) {
        ...
        var variables = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_apollo_utilities__["c" /* assign */])({}, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_apollo_utilities__["d" /* getDefaultValues */])(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_apollo_utilities__["i" /* getOperationDefinition */])(query)), options.variables);
        var sub;
        var observers = [];
        return new __WEBPACK_IMPORTED_MODULE_6__util_Observable__["a" /* Observable */](function (observer) {
            ...
            if (observers.length === 1) {
                var handler = {
                    next: function (result) {
                        ...
                        observers.forEach(function (obs) {
                            if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_apollo_utilities__["f" /* graphQLResultHasError */])(result) && obs.error) {
                ...
                sub = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_apollo_link__["b" /* execute */])(_this.link, operation).subscribe(handler);
            }
            return function () {
    ...
    QueryManager.prototype.fetchRequest = function (_a) {
        ...
        return new Promise(function (resolve, reject) {
            _this.addFetchQueryPromise(requestId, resolve, reject);
            var subscription = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_apollo_link__["b" /* execute */])(_this.deduplicator, operation).subscribe({
                next: function (result) {
                    var lastRequestId = _this.getQuery(queryId).lastRequestId;
                    if (requestId >= (lastRequestId || 1)) {
                        if (fetchPolicy !== 'no-cache') {
    ...
    QueryManager.prototype.buildOperationForLink = function (document, variables, extraContext) {
        ...
        return {
            query: cache.transformForLink
                ...
                : document,
            variables: variables,
            operationName: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_apollo_utilities__["j" /* getOperationName */])(document) || undefined,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_graphql_language_printer__ = __webpack_require__(6);
...
var QueryStore = (function () {
    ...
    QueryStore.prototype.initQuery = function (query) {
        ...
        if (previousQuery &&
            ...
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_graphql_language_printer__["print"])(previousQuery.document) !== __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_graphql_language_printer__["print"])(query.document)) {
        ...
        if (query.storePreviousVariables &&
            ...
            if (!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_apollo_utilities__["k" /* isEqual */])(previousQuery.variables, query.variables)) {
                isSetVariables = true;
...
var DataStore = (function () {
    ...
    DataStore.prototype.markQueryResult = function (result, document, variables, fetchMoreForQueryId, ignoreErrors) {
        ...
        var writeWithErrors = !__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_apollo_utilities__["f" /* graphQLResultHasError */])(result);
        if (ignoreErrors && __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_apollo_utilities__["f" /* graphQLResultHasError */])(result) && result.data) {
    ...
    DataStore.prototype.markSubscriptionResult = function (result, document, variables) {
        if (!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_apollo_utilities__["f" /* graphQLResultHasError */])(result)) {
            this.cache.write({
                result: result.data,
    ...
    DataStore.prototype.markMutationResult = function (mutation) {
        var _this = this;
        if (!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_apollo_utilities__["f" /* graphQLResultHasError */])(mutation.result)) {
            var cacheWrites_1 = [];
            cacheWrites_1.push({
            ...
            if (mutation.updateQueries) {
                Object.keys(mutation.updateQueries)
                    ...
                    var nextQueryResult = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_apollo_utilities__["l" /* tryFunctionOrLogError */])(function () {
                        return updater(currentQueryResult, {
                            mutationResult: mutation.result,
                            queryName: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_apollo_utilities__["j" /* getOperationName */])(query.document) || undefined,
            ...
            if (update_1) {
                this.cache.performTransaction(function (c) {
                    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_apollo_utilities__["l" /* tryFunctionOrLogError */])(function () { return update_1(c, mutation.result); });
                });
            }
        }
    };
...
var DedupLink = /** @class */ (function (_super) {
    ...
    DedupLink.prototype.request = function (operation, forward) {
        ...
        if (!this.inFlightRequestObservables.get(key)) {
            ...
            var subscription_1;
            var sharedObserver = new __WEBPACK_IMPORTED_MODULE_0_apollo_link__["c" /* Observable */](function (observer) {
...
var split = function (test, left, right) {
    ...
    if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__linkUtils__["a" /* isTerminating */])(leftLink) && __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__linkUtils__["a" /* isTerminating */])(rightLink)) {
...
var concat = function (first, second) {
    ...
    if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__linkUtils__["a" /* isTerminating */])(firstLink)) {
        console.warn(new __WEBPACK_IMPORTED_MODULE_1__linkUtils__["b" /* LinkError */]("You are calling concat on a terminating link, which will have no effect", firstLink));
        return firstLink;
    }
    var nextLink = toLink(second);
    if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__linkUtils__["a" /* isTerminating */])(nextLink)) {
        return new ApolloLink(function (operation) {
...
function execute(link, operation) {
    return (link.request(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__linkUtils__["c" /* createOperation */])(operation.context, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__linkUtils__["d" /* transformOperation */])(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__linkUtils__["e" /* validateOperation */])(operation)))) || __WEBPACK_IMPORTED_MODULE_0_zen_observable_ts__["a" /* default */].of());
}
...
function getDirectiveInfoFromField(field, variables) {
    if (field.directives && field.directives.length) {
        var directiveObj_1 = {};
        field.directives.forEach(function (directive) {
            directiveObj_1[directive.name.value] = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__storeUtils__["b" /* argumentsObjectFromField */])(directive, variables);
        });
...
function removeDirectivesFromDocument(directives, doc) {
    var docClone = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util_cloneDeep__["a" /* cloneDeep */])(doc);
    docClone.definitions.forEach(function (definition) {
        removeDirectivesFromSelectionSet(directives, definition.selectionSet);
    });
    var operation = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__getFromAST__["f" /* getOperationDefinitionOrDie */])(docClone);
    var fragments = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__getFromAST__["g" /* createFragmentMap */])(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__getFromAST__["h" /* getFragmentDefinitions */])(docClone));
    return isNotEmpty(operation, fragments) ? docClone : null;
}
function addTypenameToDocument(doc) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__getFromAST__["i" /* checkDocument */])(doc);
    var docClone = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util_cloneDeep__["a" /* cloneDeep */])(doc);
    docClone.definitions.forEach(function (definition) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__environment__ = __webpack_require__(12);
...
function warnOnceInDevelopment(msg, type) {
    ...
    if (!haveWarned[msg]) {
        if (!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__environment__["b" /* isTest */])()) {
            haveWarned[msg] = true;
        }
        switch (type) {
            case 'error':
...
var _graphqlTag = __webpack_require__(76);
...
var TableQL = function (_Component) {
  ...
  function TableQL(props) {
    ...
    _this.renderTableRows = _this.renderTableRows.bind(_this);
    _this.renderTableHeader = _this.renderTableHeader.bind(_this);
    ...
    */
      ...
      return displayData.map(function (data) {
        return _react2.default.createElement(
          ...
          dataKeys.map(function (column, columnIndex) {
            return _react2.default.createElement(
              'td',
              { className: _this2.props.tbodytd, key: '' + (column + columnIndex) },
    ...
    value: function renderTableHeader(dataKeys) {
      ...
      return dataKeys.map(function (column, columnIndex) {
        return _react2.default.createElement(
          'th',
          { className: _this3.props.theadth, key: '' + (column + columnIndex) },
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        _reactApollo.Query,
        {
          query: (0, _graphqlTag2.default)(this.props.query),
          variables: this.props.variables,
        ...
        function (_ref) {
          ...
          if (error) {
            ...
            return _react2.default.createElement(
              'p',
              null,
              _this4.props.errorMessage || 'Error while loading TableQL'
            );
          }
          ...
          return _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _this4.renderTableHeader(dataKeys)
              )
            ),
            _react2.default.createElement(
              'tbody',
...
var _printError = __webpack_require__(73);
...
var _syntaxError = __webpack_require__(79);

var _locatedError = __webpack_require__(78);

var _printError = __webpack_require__(73);

var _formatError = __webpack_require__(77);
...
var _blockStringValue = _interopRequireDefault(__webpack_require__(81));
...
var _directiveLocation = __webpack_require__(82);
...
var _defineToStringTag = _interopRequireDefault(__webpack_require__(80));
